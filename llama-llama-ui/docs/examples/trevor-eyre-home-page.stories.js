...
const HomePage = {
  name: 'Home page',
  render: () => html`
    <lam-container size="lg">
      <lam-stack gap="7xl">
        <lam-app-bar class="story-te-app-bar">
          <lam-stack gap="md" direction="row">
            <story-nav-link active>
              <story-icon-home></story-icon-home>
              <lam-text transform="uppercase">Home</lam-text>
            </story-nav-link>
            <story-nav-link>
              <story-icon-projects></story-icon-projects>
              <lam-text transform="uppercase">Projects</lam-text>
            </story-nav-link>
            <story-nav-link>
              <story-icon-posts></story-icon-posts>
              <lam-text transform="uppercase">Posts</lam-text>
            </story-nav-link>
            <story-nav-link>
              <story-icon-contact></story-icon-contact>
              <lam-text transform="uppercase">Contact</lam-text>
            </story-nav-link>
          </lam-stack>
          <lam-stack gap="sm" direction="row">
        ...
        <lam-container size="md" align="start">
          <lam-stack gap="4xl">
            <lam-stack gap="sm">
              <lam-text variant="secondary" size="lg" transform="uppercase">
                Trevor Eyre
              </lam-text>
              <lam-text size="4xl" transform="uppercase">
                Front End
                <br />
                Engineer
              </lam-text>
